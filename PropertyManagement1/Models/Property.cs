...
namespace PropertyManagement1.Models
{
    ...
    public partial class Property
    {
        ...
        [Display(Name = " Mã Số"), Required]
        public string Property_Code { get; set; }
        [Required(ErrorMessage = "Tên Bất Động Sản còn trống")]
        [StringLength(500, ErrorMessage = "Độ Dài Không Hợp Lệ", MinimumLength = 3)]
        [Display(Name = "Tên Bất Động Sản")]
        public string Property_Name { get; set; }

        public int Property_Type_ID { get; set; }
        [StringLength(1500, ErrorMessage = "Độ Dài Không Hợp Lệ", MinimumLength = 3)]
        public string Description { get; set; }
        public int District_ID { get; set; }
        [Required(ErrorMessage = "Địa Chỉ còn trống")]
        [StringLength(500, ErrorMessage = "Độ Dài Không Hợp Lệ", MinimumLength = 3)]
        public string Address { get; set; }
        [Display(Name = " Diện Tích"), Required]
        [Range(1, 100)]
        public Nullable<int> Area { get; set; }
        [Display(Name = "Nhập Số Phòng Ngủ"), Required]
        [Range(1, 100)]
        public Nullable<int> Bed_Room { get; set; }
        [Display(Name = "Nhập Số Phòng Tắm"), Required]
        [Range(1, 100)]
